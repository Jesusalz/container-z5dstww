...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-z5dstww.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-z5dstww.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jesusalz/container-z5dstww.git
cd container-z5dstww
```
...
```
docker attach container-z5dstww
```
